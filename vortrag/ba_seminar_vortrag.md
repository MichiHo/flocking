...
**1-D example**: In 1-D with state estimate $(x_{k | k-1},Var(x_{k | k-1}))$ comes measurement $(y_k,Var(y_k))$. Weigh both with the **inverse Variance** (higher Var -> lower Precision) to recieve:
